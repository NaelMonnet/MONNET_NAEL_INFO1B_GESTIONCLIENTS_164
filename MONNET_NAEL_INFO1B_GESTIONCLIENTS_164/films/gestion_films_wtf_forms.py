...
class FormWTFAddFilm(FlaskForm):
    ...
    """
    nom_film_regexp = ""
    nom_film_add_wtf = StringField("Nom du mail", validators=[Length(min=2, max=2000, message="min 2 caractères"),
                                                               Regexp(nom_film_regexp,message="" )])
...
class FormWTFUpdateFilm(FlaskForm):
    ...
    nom_film_update_wtf = StringField("Entrer un mail", widget=TextArea())
