...
try:
    ...
    """
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.database import database_tools
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.essais_wtf_forms import gestion_essai_wtf
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.essais_wtf_forms import gestion_wtf_forms_demo_select
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.genres import gestion_genres_crud
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.demos_om_164 import routes_demos

    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.films_genres import gestion_films_genres_crud
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.erreurs import msg_avertissements

    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.films import gestion_films_crud
    from MONNET_NAEL_INFO1B_GESTIONCLIENTS_164.films import gestion_films_wtf_forms
