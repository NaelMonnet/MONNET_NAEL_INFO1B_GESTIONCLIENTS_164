...
class MonPremierWTForm(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter le Prénom de la personne ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante (WTF) dont le contenu est basé sur la table "t_personne"
...
class DemoFormSelectWTF(FlaskForm):
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_personne = SubmitField("Choix genre")
